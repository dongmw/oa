...
<div class="am-g">
    <div class="am-u-lg-6 am-u-md-8 am-u-sm-centered">
        ...
        <form id="register" method="post" action="<?php echo U('do_register');?>" class="am-form">
            <label for="email">用户名:</label>
            <input type="text" name="username" id="email" value="" class="required" >
            <br>
            <label for="password">密码:</label>
            <input type="password" name="password" id="password" value="" required minlength="8" >
            <br>
            <label for="password">确认密码:</label>
            <input type="password" name="check_password" id="check_password" value="" required minlength="8" equalTo="#password">
            <br>
