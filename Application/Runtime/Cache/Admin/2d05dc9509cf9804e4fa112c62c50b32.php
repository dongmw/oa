...
<div class="am-cf admin-main">
    ...
    <div class="am-cf am-padding">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">新增部门</strong> /
                ...
                <form class="am-form" action="<?php echo U('edit');?>" method="post">
                    ...
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                            <select name="parent_id" id="parent_id">
                                ...
                                <option disabled value="" >&nbsp;&nbsp;二级部门:</option>
                                <?php if(is_array($departs)): $i = 0; $__LIST__ = $departs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?><option value="<?php echo ($d["id"]); ?>" >&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($d["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8 am-u-md-4">
                            <input type="text" class="am-input-sm" name="name" value="<?php echo ($depart["name"]); ?>">
                        </div>
                    ...
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                            <textarea rows="4" name="desc"><?php echo ($depart["desc"]); ?></textarea>
                        </div>
                    </div>
