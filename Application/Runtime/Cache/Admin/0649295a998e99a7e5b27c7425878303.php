                    ...
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                            <select name="parent_id" id="parent_id">
                                <option value="0" class="am-selected-status am-fl">顶级部门</option>
                                <option value="" >&nbsp;&nbsp;二级部门:</option>
                                <?php if(is_array($departs)): $i = 0; $__LIST__ = $departs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$depart): $mod = ($i % 2 );++$i;?><option value="<?php echo ($depart["id"]); ?>">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($depart["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
