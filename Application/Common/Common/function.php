...
function send_mail($title, $content, $from, $to, $chart = 'utf-8', $attachment = '') {
    ...
    $mail->FromName = "HYAC"; // 设置发件人的姓名
    $mail->SMTPAuth = true; // 设置SMTP是否需要密码验证，true表示需要
    $mail->Username = "943113712@qq.com"; // 设置发送邮件的邮箱
    $mail->Password = "afgsohoukvoqbdda"; // 设置邮箱的密码
    ...
    $mail->AddAddress ( $to, "15057518924@163.com" ); // 设置收件的地址
    if ($attachment != '') {
